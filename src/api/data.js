export const data = [
    ...
    alt: [
      {
        name: "Coconut Cream",
        description:
          "Because of it's naturally high fat content, coconut cream is a great alternative for diary cream. Serve with desserts or use for cooking.",
        recipe:
          "Recipe: Chill a can of full-fat coconut milk until firm. Pour away the liquid and whip the remains with a handheld mixer."
      }
    ]
  },
  {
    ...
    alt: [
      {
        ...
        recipe:
          "Recipe: 250mL of nut milk, 1 tbsp of apple cider vinegar or fresh lemon juice. Let sit for 15minutes, stirring occasionally."
      }
    ]
  },
  {
    ...
    alt: [
      {
        ...
        recipe:
          "Recipe: 150g cashews, soaked for 2-3hours, 2 tbsp fresh lemon juice, 1 tsp apple cider vinegar, 1 tsp garlic powder and a dash of salt. Blend and store refridgerated."
      }
    ]
  },
  {
    ...
    name: "Bacon",
    alt: [
      { name: "Smoked Tofu", description: "", recipe: "" },
      { name: "Smoked Seitan", description: "", recipe: "" }
    ]
  },
  {
    id: 10,
    name: "Scrambled Egg",
    alt: [{ name: "Scrambled Tofu", description: "", recipe: "" }]
  },
  {
    id: 11,
    name: "Yoghurt",
    alt: [
      { name: "Soy Yoghurt", description: "", recipe: "" },
      { name: "Coconut Yoghurt", description: "", recipe: "" },
      { name: "Almond Yoghurt", description: "", recipe: "" }
    ]
  },
  {
    id: 12,
    name: "Mayonnaise",
    alt: [{ name: "Vegan Mayonnaise", description: "", recipe: "" }]
  },
  {
    id: 13,
    name: "Chicken Stock",
    alt: [{ name: "Vegetable Stock", description: "", recipe: "" }]
  },
  {
    id: 14,
    name: "Beef Stock",
  ...
  },
  {
    id: 17,
    name: "Parmesan",
    alt: [{ name: "Vegan Parmesan", description: "", recipe: "" }]
  },
  {
    id: 18,
    name: "Cream Cheese",
    alt: [{ name: "Cashew Cream Cheese", description: "", recipe: "" }]
  },
  {
    id: 19,
    name: "Milk Chocolate",
    alt: [
      { name: "Dark Chocolate", description: "", recipe: "" },
      { name: "Vegan Chocolate", description: "", recipe: "" }
    ]
  },
  {
    id: 20,
    name: "Honey",
    alt: [
      { name: "Maple Syrup", description: "", recipe: "" },
      { name: "Agave Syrup", description: "", recipe: "" },
      { name: "Raw Brown Sugar", description: "", recipe: "" }
    ]
  },
  {
    id: 21,
  ...
  },
  {
    id: 22,
    name: "Pulled Pork",
    alt: [{ name: "Pulled Jackfruit", description: "", recipe: "" }]
  },
  {
    id: 23,
    name: "Pulled Chicken",
  ...
  },
  {
    ...
    name: "Salmon",
    alt: [
      { name: "Marinated Carrot", description: "", recipe: "" },
      { name: "Vegan Lox", description: "", recipe: "" }
    ]
  },
  {
    id: 25,
    name: "Ground Beef",
    alt: [{ name: "Minced Tofu", description: "", recipe: "" }]
  },
  {
    id: 26,
    name: "Gummibears",
    alt: [{ name: "Vegan Gummibears", description: "", recipe: "" }]
  }
];
